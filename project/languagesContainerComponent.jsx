...
export default function lanquagesContainerComponent() {
    return (
        <>

        <div className="lanquage-container">

            {languages.map((obj, index) => <LanquageComponent key = {index} name = {obj.name} backgroundColor = {obj.backgroundColor} color = {obj.color}/>)}
