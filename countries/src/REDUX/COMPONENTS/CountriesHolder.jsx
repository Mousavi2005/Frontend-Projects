...
export default function CountriesHolder() {
    ...
    return(
        <div className="w-full h-full px-[10%] md:px-[3%]">
            <div className="w-full h-full flex flex-col items-center gap-12 md:gap-10 py-5 md:flex-row md:flex-wrap md:justify-center md:bg-[#f2f2f2]">
